 <div class="container">
    ...
    <div class="card">
        ...
        <span class="card-title">{{ $vots->title }} </span>
        <p>
            {{ $vots->description }}
        </p>
        <br/>
        ...
        <ul class="collapsible" data-collapsible="expandable">
            ...
            <li style="box-shadow:none;">
              <div class="collapsible-header">{{ $questions->title }} <a href="#" style="float:right;">Edit</a></div>
                ...
                <div style="margin:5px; padding:10px;">
                    ...
                    <div class="row">
                     ...
                     @elseif($questions->question_type ==='radio')
                      ...
                      @foreach($questions['option_name'] as $key=>$value)
      ...
      <h2 class="flow-text">Add Question</h2>
        <form id="boolean" wire:submit.prevent='AddQuestion'>

          <div class="row">
            <div class="input-field col s12">
              <select class="browser-default" wire:model="question_type" id="question_type">
            ...
            <div class="input-field col s12">
              <input name="title" id="title" type="text" wire:model="title">
